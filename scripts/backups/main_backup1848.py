...
bins = np.linspace(0.0, 10.0, 50.0)

# bins = np.arange(0,5,0.1)  # 0.1 was good @TODO:maybe do this for all, using same range of boxplots to histograms

pyplot.hist(money_2008_adj_arr, bins, alpha=0.5, density=True,label='Marketing Expenditure in 2008 (in million GBP)')
...
# @BINNED MODE AUTO
#pyplot.hist(money_2008_adj_arr, bins=None, log=True, alpha=0.5, label='Marketing Expenditure in 2008 (in million GBP)')
#pyplot.hist(money_2009_adj_arr, bins=None, alpha=0.5, label='Marketing Expenditure in 2009 (in million GBP)')
...
pdf = kde_scipy(x=money_2008_adj_arr, x_grid=bins)

pyplot.plot(bins, pdf, color='blue', alpha=0.5, lw=3)
